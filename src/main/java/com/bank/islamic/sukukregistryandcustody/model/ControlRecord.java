package com.bank.islamic.sukukregistryandcustody.model;
...
/**
 * The BIAN control record for this service domain: "Sukuk Holding Administrative Plan".
 *
 ...
 * to its asset type (Sukuk Holding). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Sukuk Holding Administrative Plan";
